...
public class PongGame extends Application {
   ...
   /*
    Check for collisitions with players pads and
    decides which direction the balll should travel
    */ 
   private void Padels()
   {
   ...
   /* 
   Check for collisitions with players 1 and walls 3 and 4, 
   and decides which direction the balll should travel
   */
    ...
    /* 
   Check for collisitions with players 2 and walls 3 and 4, 
   and decides which direction the balll should travel
   */
